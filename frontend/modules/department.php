...
<div class="menubody">
        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <td class="last"><a href="?action=quanlysanpham&query=update&product_id=<?php echo $row['product_id'] ?>&category_id=<?php echo $row['category_id'] ?>"class="btn btn-primary">Sửa</a></td>
            </tr>
          <?php
          }
          ?>
  ...
  <?php 
    ...
    {
    ?>
   <a href="index.php?action=department&query=none&<?php if(isset($_GET['id'])) echo 'id='.$id.'&' ?>page=<?php echo $i ?>" <?php if($i==$page) echo 'class="page"'; else echo 'class="page active"';?> ><?php echo $i ?></a>
    <?php
    }
    ?>
    </div>
